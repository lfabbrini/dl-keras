...
#                              batch_size = 32,
    ...
    #custom metrics
    f1 = metrics.F1Generator(validation_data=test_generator)
    callbacks_list.append(f1)
    #-----------
    #input("Press Enter to continue ...")
    #-----------
    start = time()
    history = model.fit_generator(val_generator,epochs=epochs,validation_data=test_generator,callbacks=callbacks_list)
    end = time()
    took = end - start
